...
const IndexCom = ({ price }) => {
  ...
  return (
    <>
                ...
                <Suspense fallback={<div>Loading...</div>}>
                          ...
                          <div
                            ...
                            className={`rounded-full ${
                              index === currentPhotoIndices[place._id]
                                ? "bg-blue-500 md:w-2 md:h-2 w-1 h-1"
                  ...
                  >
                    <svg
                      ...
                      stroke="white"
                      strokeWidth="2"
                      className={`w-5 h-5 md:w-7 md:h-7 transform hover:scale-110 transition-transform text-${
                        place.likeStatus ? "red-600" : "gray-400"
                      }`}
                    >
      ...
      <h2 className="font-bold text-3xl text-blue-500 mt-1 px-4 flex justify-center underline">
        User's Experience...
      </h2>
