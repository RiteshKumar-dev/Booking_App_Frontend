    ...
    <>
      <header className="lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:mt-5 lg:z-10 flex justify-around items-center lg:px-4 lg:py-2 md:px-4 md:py-2 bg-white lg:shadow-sm">
        <div className="lg:flex md:flex gap-5 overflow-hidden lg:mt-16">
          ...
          >
            <div className="inline-block mx-1 my-1 p-2">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 transition-opacity duration-300 ease-in-out hover:opacity-100 opacity-80"
              >
                <path
                  strokeLinecap="round"
              ...
              <span className="underline-none hover:underline hover:text-blue-700">
                Trending
              </span>
            </div>
          ...
          <FilterCom />
          <ToggleSwitch isOn={isGSTOn} handleToggle={handleToggleGST} />
        </div>
      </header>
    </>
  );
...
export default PlaceOptionsCom;
